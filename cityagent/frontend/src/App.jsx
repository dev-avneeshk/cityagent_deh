...
import { Wind, Briefcase, CloudRain, MessageSquare } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="h-screen w-screen bg-bg-deep flex overflow-hidden">
      <Sidebar />
      
      <main className="flex-1 flex flex-col overflow-hidden relative">
        <Topbar />
        
        <div className="flex-1 overflow-y-auto custom-scrollbar p-[20px_24px]">
          
          {/* ROW 1: STAT CARDS */}
          <div className="grid grid-cols-4 gap-[12px] mb-4">
          ...
          {/* ROW 3: BOTTOM GRID */}
          <div className="grid grid-cols-[1fr_320px] gap-[12px]">
            {/* Left Column Stack */}
            <div className="flex flex-col gap-[12px]">
              <div className="h-[220px]">
                <AnomalyChart data={data.anomalies} />
              </div>
              <div className="grid grid-cols-2 gap-[12px] h-[300px]">
